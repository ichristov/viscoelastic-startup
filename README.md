...
- F. M. Fern&aacute;ndez has published dozens of such Comments, most of them on methods rather than on particular solutions: [Comment on &ldquo;Analytical approach for solving population balances: a homotopy perturbation method&rdquo;](https://doi.org/10.1088/1751-8121/ab8e02), _J. Phys. A: Math. Theor._ **53** (2020) 388001; [On two new applications of the homotopy analysis method and the homotopy perturbation method](https://doi.org/10.1088/0031-8949/81/03/037002), _Phys. Scr._ **81** (2010) 037002; and [Comment on &ldquo;The asymptotic iteration method revisited&rdquo;](https://doi.org/10.1063/5.0008333), _J. Math. Phys._ **61** (2020) 064101. Unpublished, but the best title of the genre: [Homotopy perturbation method: when infinity equals five](https://arxiv.org/abs/0810.3318) ([arXiv:0810.3318](https://arxiv.org/abs/0810.3318), 2008), on a heat-transfer paper whose infinity turns out to be five.
