...
- `digitize_balan_fig3a_fig2.py` reads $v(\xi, t)$ from Fig. 3(a) at the six distances from the plate, and the
  Newtonian velocity profiles of Fig. 2, and compares both with the exact solutions.
